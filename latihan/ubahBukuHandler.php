<pre>
    <?php
        ...
        $query="UPDATE buku SET judul='$judul',cover='$cover,pengarang='$pengarang',penerbit='$penerbit',jenis='$jenis',kategori_rpl='$kategori_rpl',kategori_elektronika='$kategori_elektronika',ketersediaan='$ketersediaan',harga='$harga',jumlah='$jumlah' WHERE kode='$kode'";
